...
const STATUS_STYLES = {
  ...
  PENDING:      { dark: 'bg-amber-900/50 text-amber-300 border-amber-800',       light: 'bg-amber-50 text-amber-700 border-amber-200' },
  ...
  'In Transit': { dark: 'bg-blue-900/50 text-blue-300 border-blue-800',          light: 'bg-blue-50 text-blue-700 border-blue-200' },
  'On the way': { dark: 'bg-blue-900/50 text-blue-300 border-blue-800',          light: 'bg-blue-50 text-blue-700 border-blue-200' },
};
